          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div style={{ position: 'relative', flex: 1, minWidth: 0 }}>
              ...
              <input
                ...
                style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: startDate ? 44 : 0, opacity: 0, cursor: 'pointer', zIndex: 1 }}
              />
              {startDate && (
            ...
            <div style={{ position: 'relative', flex: 1, minWidth: 0 }}>
              ...
              <input
                ...
                style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: endDate ? 44 : 0, opacity: 0, cursor: 'pointer', zIndex: 1 }}
              />
              {endDate && (
