            ...
            <div style={{ position: 'relative', flex: 1, minWidth: 0 }}>
              ...
              >
                ...
                {!startDate ? (
                  ...
                  <button type="button" onClick={e => { e.stopPropagation(); setStartDate(''); }}
                    style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#94a3b8', fontSize: 15, lineHeight: 1, padding: '2px 4px' }}>
                    ✕
                  </button>
                )}
              </div>
            ...
            <div style={{ position: 'relative', flex: 1, minWidth: 0 }}>
              ...
              >
                ...
                {!endDate ? (
                  ...
                  <button type="button" onClick={e => { e.stopPropagation(); setEndDate(''); }}
                    style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#94a3b8', fontSize: 15, lineHeight: 1, padding: '2px 4px' }}>
                    ✕
                  </button>
                )}
