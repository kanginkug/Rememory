...
export default function CreateMemoryPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      alert('추억 만들기에 실패했습니다. 다시 시도해주세요.');
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 style={{ fontSize: 18, fontWeight: 700, color: '#333' }}>새 추억 만들기</h1>
        <div style={{ width: 30 }} />
      </header>
      ...
      >
        ...
        >
          ...
          <label
            style={{ position: 'relative', display: 'inline-block', width: 48, height: 26, flexShrink: 0, marginLeft: 12 }}
          >
            <input
              type="checkbox"
              checked={showHistory}
